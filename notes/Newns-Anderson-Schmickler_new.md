...
Heterogeneous Catalysis THE NEWNS–ANDERSON MODEL P185页,从矩阵里面看出Gaa.[6]
...
相对于初态最低点 $E_{i,\min}=\epsilon_a$，得到反应的活化能 $E_{\rm act}$：

$$
E_{\rm act}=E^{\ddagger}-\epsilon_a=\frac{\epsilon_a^2}{4\lambda}
\tag{44}
$$
