...
我们先来念一则悼词: 第一张图片是Manos Mavrikakis & Jin Suntivich Nature Materials 2023, 他们用SFG测量了金属水表面的PZC,这也几乎彻底宣告了用最大熵方法测量PZC已经死去. 或者在未来的金属水的界面动力学和传热的研究中还能见到它.
...
由于表面金属原子的截断,金属几乎天然的溢出电子,如果所以往往天然金属表面都是带有荷的.
...
在了解这些概念之前,您可以先了解什么是电极电势,当我们测量电极电势的是否我们在测的是什么?**[what is electrode potential](what is electrode potential.md)**
...
SFG**[SFG](SFG_QM math-cleaned-v2.md)**测量表面电场,西湖大学王鸿飞和Northwestern University的Franz M. Geiger的杰作.\[12\]
